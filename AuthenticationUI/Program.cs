...
builder.Services.AddScoped<WebApplicationShared.CustomAuthStateProvider>();
builder.Services.AddScoped<AuthenticationStateProvider, WebApplicationShared.CustomAuthStateProvider>();
